...
<body>
    <div class="bg-blue-100 w-screen h-screen flex items-center justify-center">
        <div class="bg-white w-[600px] h-[600px] rounded-xl">
            ...
            <input type="text"
                class="bg-slate-50 w-[560px] h-[50px] text-black pl-5 ml-5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></input>
            <div class="bg-transparent w-full h-[40px] mt-6 flex items-center justify-center">
                <button

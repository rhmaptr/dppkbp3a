<div class="bg-white w-[270px] h-screen flex-col shadow-lg">
    <!-- beranda -->
    <div onclick="window.location.href='http://localhost:8000/beranda'" name="beranda"
        class="w-full h-[40px] mt-3 flex bg-[#f3f1f1] bg-opacity-50">
        ...
        <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Beranda
        </div>
        <div class="bg-blue-500 w-[5px] h-full"></div>
    </div>
    <!-- pengaduan -->
    <div onclick="window.location.href='http://localhost:8000/pengaduan'" name="pengaduan"
        class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-70 : bg-[#f3f1f1] bg-opacity-50">
        <div class="bg-transparent w-[45px] flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
                <path
    ...
    <!-- poster -->
    <div onclick="window.location.href='http://localhost:8000/poster'" name="poster"
    ...
    <!-- dokumentasi -->
    <div onclick="window.location.href='http://localhost:8000/dokumentasi'" name="dokumentasi"
        class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
        <div class="bg-transparent w-[45px] flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
                <path
    ...
    <!-- berita -->
    <!-- <div onclick="window.location.href='http://localhost:8000/berita_admin'" name="berita"
        class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
        <div class="bg-transparent w-[45px] flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
                <path
    ...
    <a href="/berita_admin" class="{{ request()->is('berita_admin') ? 'bg-blue-600' : 'text-blue-800 hover:bg-yellow-600 hover:font-medium' }} bg-white w-[45px] flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
            <path
                d="M216,40H40A16,16,0,0,0,24,56V216a8,8,0,0,0,11.58,7.15L64,208.94l28.42,14.21a8,8,0,0,0,7.16,0L128,208.94l28.42,14.21a8,8,0,0,0,7.16,0L192,208.94l28.42,14.21A8,8,0,0,0,232,216V56A16,16,0,0,0,216,40Zm0,163.06-20.42-10.22a8,8,0,0,0-7.16,0L160,207.06l-28.42-14.22a8,8,0,0,0-7.16,0L96,207.06,67.58,192.84a8,8,0,0,0-7.16,0L40,203.06V56H216ZM136,112a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,112Zm0,32a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,144ZM64,168h48a8,8,0,0,0,8-8V96a8,8,0,0,0-8-8H64a8,8,0,0,0-8,8v64A8,8,0,0,0,64,168Zm8-64h32v48H72Z">
            </path>

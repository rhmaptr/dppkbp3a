...
<body>
    ...
    <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
        ...
        <!-- poster -->
        <div name="poster" class="w-full h-[40px] flex bg-[#f3f1f1] bg-opacity-50">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Poster</div>

    ...
    <x-side2></x-side2>
        <div class="bg-transparent w-full h-screen ">
            ...
            <div class="bg-transparent w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
                <div class="bg-transparent w-full h-[35px] font-semibold text-[20px] pt-1 pl-3">Tugas Pokok</div>
                ...
                <script>
                    document.getElementById("edit_tugas").addEventListener("click", function() {
                        window.location.href = "/edit_tugas";
                    });
                    </script>

...
<body>
    ...
    <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
        <!-- beranda -->
        <div name="beranda" class="bg-white w-full h-[40px] mt-3 flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          ...
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Beranda</div>
        </div>
        <!-- pengaduan -->
        <div name="pengaduan" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
        ...
        <!-- dokumentasi -->
        <div name="dokumentasi" class="w-full h-[40px] flex bg-[#f3f1f1] bg-opacity-50">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Dokumentasi</div>
  ...
  ?>
        ...
        <div class="bg-transparent w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
            <div class="bg-transparent w-full h-[35px] font-semibold text-[20px] pt-1 pl-3">Dokumentasi</div>
            <div class="bg-transparent w-full h-[35px] font-semibold text-[20px] pl-3 flex">
                ...
                />
            <button type="submit" class="absolute right-2 top-[18px] transform -translate-y-1/2 text-gray-500 hover:text-blue-500"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#000000" viewBox="0 0 256 256"><path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path></svg></button>
            </form>
            <button type="submit" class="bg-[#3B86FE] w-[110px] h-[35px] ml-[750px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] shadow-md">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ffffff" viewBox="0 0 256 256"><path d="M224,128a8,8,0,0,1-8,8H136v80a8,8,0,0,1-16,0V136H40a8,8,0,0,1,0-16h80V40a8,8,0,0,1,16,0v80h80A8,8,0,0,1,224,128Z"></path></svg> <span class="pl-2">Tambah</span>
            </button>
            </div>
                ...
                <tr class="bg-gray-50 ">
                    ...
                    <td class=" px-4 py-2  flex items-center justify-center">
                        <div class="bg-transparent w-[70px] h-[30px] flex">
                            <div class="bg-transarent w-[35px] h-full flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#59a1ee" viewBox="0 0 256 256"><path d="M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM192,108.68,147.31,64l24-24L216,84.68Z"></path></svg></div>
                            <div class="bg-transparent w-[35px] h-full flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ea3939" viewBox="0 0 256 256"><path d="M224,56a8,8,0,0,1-8,8h-8V208a16,16,0,0,1-16,16H64a16,16,0,0,1-16-16V64H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,56ZM88,32h80a8,8,0,0,0,0-16H88a8,8,0,0,0,0,16Z"></path></svg></div>
                        </div>
                    </td>
                </tr>

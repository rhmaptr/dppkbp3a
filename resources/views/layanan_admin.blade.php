...
<body>
    ...
    <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
        ...
        <!-- layanan -->
        <div name="layanan" class="w-full h-[40px] flex bg-[#f3f1f1] bg-opacity-50">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Layanan</div>
  ...
  ?>
        ...
        <div class="bg-transparent w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
            <div class="bg-transparent w-full h-[35px] font-semibold text-[20px] pt-1 pl-3">Layanan</div>

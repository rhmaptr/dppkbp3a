        ...
        <div class="bg-blue-400 w-full h-screen ">
            ...
            <div class="bg-green-300 w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
                ...
                <div class="bg-yellow-300 w-full h-[35px] font-semibold text-[20px] pl-3 flex items-center">
                    ...
                    <button type="button"
                        class="bg-[#3B86FE] w-[110px] h-[35px] ml-[760px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] shadow-md"
                        onclick="openModal()">
                    ...
                    <div class="bg-white w-[600px] h-[600px] rounded-xl">
                        <div class="bg-transparent w-full h-[35px] flex ">
                            <div
                                ...
                                Tambah Berita</div>
                            <button
                                class="bg-transparent w-[50px] h-full text-white flex items-center justify-center ml-96 hover:bg-red-500"
                                onclick="closeModal()">
                                            ...
                                            <div class="bg-yellow-300 w-[70px] h-[30px] flex">
                                                ...
                                                <div id="myModal"
                                                    ...
                                                    <div class="bg-white w-[600px] h-[600px] rounded-xl">
                                                        ...
                                                        <div class="bg-black w-full h-1"></div>
                                                        <div
                                                            class="bg-transparent w-full h-[30px] mt-3 font-medium text-[18px] pl-5">
                                                            Gambar</div>
                                                        <div class="bg-transparent w-full h-[140px]">
                                                            <div name="image"
                                                                class="bg-slate-50 w-[560px] ml-5 h-full rounded-lg border-slate-200 border-2 shadow-md flex items-center justify-center relative overflow-hidden">
                                                                <button onclick="openFileDialog()">
                                                                    <img id="cameraIcon" src="camera-plus.svg"
                                                                        alt="Kamera" class="w-full h-full object-cover">
                                                                </button>
                                                        ...
                                                        <div
                                                            class="bg-transparent w-full h-[30px] mt-1 font-medium text-[18px] pl-5">
                                                            Judul</div>
                                                        <div class="bg-transparent w-full h-[50px]">
                                                            <input type="text" name="title"
                                                                class="bg-slate-50 w-[560px] h-full text-black pl-5 ml-5 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                        ...
                                                        <div
                                                            class="bg-transparent w-full h-[30px] mt-2 font-medium text-[18px] pl-5">
                                                            Artikel</div>
                                                        <div class="bg-transparent w-full h-[40px]">
                                                            <textarea name="content"
                                                                class="bg-slate-50 w-[560px] h-[80px] text-black ml-5 pl-5 border border-gray-300 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"></textarea>
                                                        ...
                                                        <div
                                                            class="bg-transparent w-full h-[40px] mt-16 flex items-center justify-center">
                                                            <button
                                                                class="bg-[#3B86FE] w-[560px] h-[40px] text-white flex items-center justify-center rounded-lg shadow-md hover:bg-[#336fd1]">Simpan</button>
                                                        </div>
                                                    </div>

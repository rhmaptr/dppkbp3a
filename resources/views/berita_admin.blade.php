    ...
    <div class="bg-white w-screen h-screen flex">
        <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
            ...
            <div onclick="window.location.href='http://localhost:8000/beranda'" name="beranda"
                class="bg-white w-full h-[40px] mt-3 flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
            ...
            <!-- berita -->
            <div onclick="window.location.href='http://localhost:8000/berita_admin'" name="berita" class=" w-full h-[40px] flex bg-[#f3f1f1] bg-opacity-50">
                <div class="bg-transparent w-[45px] flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256">
                        <path
                ...
                <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Berita
                </div>
        ...
        <div class="bg-transparent w-full h-screen ">
            ...
            <div class="bg-transparent w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
                ...
                <div class="bg-transparent w-full h-[35px] font-semibold text-[20px] pl-3 flex">
                    ...
                    <button id="popup" onclick="window.location.href='http://localhost:8000/tambah_berita'"
                        type="submit"

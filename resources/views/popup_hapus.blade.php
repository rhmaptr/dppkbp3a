    ...
    <div class="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50" id="popup">
        <div class="bg-white rounded-lg shadow-lg p-6 w-80">
            ...
            <div class="flex justify-center items-center mt-4">
                <button class="px-4 py-1 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 mr-2"
                    onclick="closePopup()">
                    Batal
                </button>
                <button class="px-4 py-1 bg-red-500 text-white rounded-lg hover:bg-red-600" onclick="deleteItem()">
                    Hapus
                </button>
            </div>
        </div>

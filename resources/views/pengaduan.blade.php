...
<body>
    <div class="bg-white w-screen h-screen flex">
        ...
        <!-- pengaduan -->
        <div name="pengaduan" class=" w-full h-[40px] flex bg-[#f3f1f1] bg-opacity-50">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Pengaduan</div>
  ...
  ?>
        ...
        <div class="bg-transparent w-[1100px] h-[550px] mt-10 ml-8 rounded-lg shadow-lg flex-col">
            <div class="bg-transparent w-full h-[40px] font-semibold text-[20px] pt-1 pl-3">Pengaduan Program Dppkbp3a</div>
            ...
            <div class="bg-transparent w-[1070px] h-[450px] mt-2 ml-3 rounded-lg shadow-lg flex-col">
                ...
                <tr class="bg-gray-50 ">
                    ...
                    <td class=" px-4 py-2 text-center">kb</td>
                    <td class=" px-4 py-2 text-center">rahma</td>
                    <td class=" px-4 py-2  flex items-center justify-center">
                    <button class="bg-[#3B86FE] w-[75px] h-[30px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Detail</button>
                    </td>
                </tr>
                <tr class="bg-gray-50 border-2 border-gray-300">
                    ...
                    <td class=" px-4 py-2 text-center">perlindungan anak</td>
                    <td class=" px-4 py-2 text-center">asya</td>
                    <td class=" px-4 py-2 flex items-center justify-center">
                    <button class="bg-gray-400 w-[75px] h-[30px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Detail</button>
                    </td>
                </tr>
                <tr class="bg-gray-50 border-2 border-gray-300">
                    <td class=" px-4 py-2 text-center">3</td>
                    <td class=" px-4 py-2 text-center">12 desember</td>
                    <td class=" px-4 py-2 text-center">pemberdayaan perempuan</td>
                    <td class=" px-4 py-2 text-center">pemberdayaan perempuan</td>
                    <td class=" px-4 py-2 text-center">sasa</td>
                    <td class=" px-4 py-2 flex items-center justify-center">
                    <button class="bg-gray-400 w-[75px] h-[30px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Detail</button>
                    </td>
                </tr>

                                ...
                                <tbody>
                                    <tr class="bg-gray-50 ">
                                        ...
                                        <td class=" px-4 py-2  flex items-center justify-center">
                                            <button
                                                class="bg-[#3B86FE] w-[75px] h-[30px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Detail</button>
                                        </td>
                                    </tr>
                                    <tr class="bg-gray-50 border-2 border-gray-300">
                                        ...
                                        <td class=" px-4 py-2 flex items-center justify-center">
                                            <button
                                                class="bg-gray-400 w-[75px] h-[30px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Detail</button>
                                        </td>
                                    </tr>
                                    <tr class="bg-gray-50 border-2 border-gray-300">

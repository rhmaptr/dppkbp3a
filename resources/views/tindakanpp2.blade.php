    ...
    <div class="bg-transparent w-screen h-screen no-scrollbar">
        ...
        <div class="bg-white w-full h-full no-scrollbar flex">
            <div class="bg-transparent w-[720px] h-full">
                ...
                <div class="bg-white w-[575px] h-[40px] -mt-4 ml-10 font-semibold text-[25px]">Pemberdayaan Perempuan</div>
                <div class="bg-transparent w-[620px] h-[500px] mt-5 ml-10">
                    <div class="bg-white w-[125px] h-[25px] text-slate-900 font-semibold text-[15px]">Jenis Program</div>
                    ...
                    <div class="bg-white w-[325px] h-[25px] mt-3 text-slate-900 font-semibold text-[15px]">Tingkat Pendidikan Terakhir</div>
                    <input type="text" class=" w-[620px] h-[40px] text-black pl-[15px] pb-[2px] border-2 border-slate-300 rounded-lg shadow-md"></input>
                    <div class="bg-white w-[325px] h-[25px] mt-3 text-slate-900 font-semibold text-[15px]">Status pendidikan Terakhir</div>
                    <input type="text" class=" w-[620px] h-[40px] text-black pl-[15px] pb-[2px] border-2 border-slate-300 rounded-lg shadow-md"></input>
                    <div class="bg-white w-[325px] h-[25px] mt-3 text-slate-900 font-semibold text-[15px]">Status Ekonomi Keluarga</div>
                        <select name="" id="" class="w-[620px] h-[40px] text-black pl-[15px] pb-[2px] border-2 border-slate-300 rounded-lg shadow-md">
                    ...
                    <div class="bg-white w-[325px] h-[25px] mt-3 text-slate-900 font-semibold text-[15px]">Jumlah Tanggungan Keluarga</div>
                    <input type="text" class=" w-[620px] h-[40px] text-black pl-[15px] pb-[2px] border-2 border-slate-300 rounded-lg shadow-md"></input>

...
<body>
    <div class="bg-blue-100 w-screen h-screen flex items-center justify-center">
        <div class="bg-white w-[600px] h-[450px] rounded-xl">
            ...
            <div class="bg-transparent w-full h-[30px] mt-5 font-medium text-[18px] pl-5">Visi</div>
            ...
            <div class="bg-transparent w-full h-[30px] mt-5 font-medium text-[18px] pl-5">Misi</div>
            ...
            <div class="bg-transparent w-full h-[40px] mt-36 flex items-center justify-center">
                <button

...
<body>
    <div class="bg-white w-screen h-screen flex">
      <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
        <!-- beranda -->
        <div onclick="window.location.href='http://localhost:8000/beranda'" name="beranda" class="w-full h-[40px] mt-3 flex bg-[#f3f1f1] bg-opacity-50">
        ...
        <!-- pengaduan -->
        <div onclick="window.location.href='http://localhost:8000/pengaduan'" name="pengaduan" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-70">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
        ...
        <!-- layanan -->
        <div onclick="window.location.href='http://localhost:8000/layanan_admin'" name="layanan" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">

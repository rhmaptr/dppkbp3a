...
<body>
    <div class="bg-white w-screen h-screen flex">
      <div class="bg-white w-[270px] h-screen flex-col shadow-lg">
        <!-- beranda -->
        <div name="beranda" class="w-full h-[40px] mt-3 flex bg-[#f3f1f1] bg-opacity-50">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256"><path d="M240,208H224V136l2.34,2.34A8,8,0,0,0,237.66,127L139.31,28.68a16,16,0,0,0-22.62,0L18.34,127a8,8,0,0,0,11.32,11.31L32,136v72H16a8,8,0,0,0,0,16H240a8,8,0,0,0,0-16ZM48,120l80-80,80,80v88H160V152a8,8,0,0,0-8-8H104a8,8,0,0,0-8,8v56H48Zm96,88H112V160h32Z"></path></svg>
          </div>
          <div class="bg-transparent w-[174px] flex items-center text-[17px] font-medium cursor-pointer">Beranda</div>
        ...
        <div name="pengaduan" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-70">
          ...
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Pengaduan</div>
        </div>
        <!-- poster -->
        <div name="poster" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Poster</div>
        </div>
        <!-- visi misi -->
        <div name="visi" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256"><path d="M176,232a8,8,0,0,1-8,8H88a8,8,0,0,1,0-16h80A8,8,0,0,1,176,232Zm40-128a87.55,87.55,0,0,1-33.64,69.21A16.24,16.24,0,0,0,176,186v6a16,16,0,0,1-16,16H96a16,16,0,0,1-16-16v-6a16,16,0,0,0-6.23-12.66A87.59,87.59,0,0,1,40,104.49C39.74,56.83,78.26,17.14,125.88,16A88,88,0,0,1,216,104Zm-16,0a72,72,0,0,0-73.74-72c-39,.92-70.47,33.39-70.26,72.39a71.65,71.65,0,0,0,27.64,56.3A32,32,0,0,1,96,186v6h64v-6a32.15,32.15,0,0,1,12.47-25.35A71.65,71.65,0,0,0,200,104Zm-16.11-9.34a57.6,57.6,0,0,0-46.56-46.55,8,8,0,0,0-2.66,15.78c16.57,2.79,30.63,16.85,33.44,33.45A8,8,0,0,0,176,104a9,9,0,0,0,1.35-.11A8,8,0,0,0,183.89,94.66Z"></path></svg>
          </div>
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Visi Misi</div>
        </div>
        <!-- layanan -->
        <div name="layanan" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256"><path d="M232,48H160a40,40,0,0,0-32,16A40,40,0,0,0,96,48H24a8,8,0,0,0-8,8V200a8,8,0,0,0,8,8H96a24,24,0,0,1,24,24,8,8,0,0,0,16,0,24,24,0,0,1,24-24h72a8,8,0,0,0,8-8V56A8,8,0,0,0,232,48ZM96,192H32V64H96a24,24,0,0,1,24,24V200A39.81,39.81,0,0,0,96,192Zm128,0H160a39.81,39.81,0,0,0-24,8V88a24,24,0,0,1,24-24h64ZM160,88h40a8,8,0,0,1,0,16H160a8,8,0,0,1,0-16Zm48,40a8,8,0,0,1-8,8H160a8,8,0,0,1,0-16h40A8,8,0,0,1,208,128Zm0,32a8,8,0,0,1-8,8H160a8,8,0,0,1,0-16h40A8,8,0,0,1,208,160Z"></path></svg>
          </div>
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Layanan</div>
        </div>
        <!-- dokumentasi -->
        <div name="dokumentasi" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          ...
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Dokumentasi</div>
        </div>
        <!-- berita -->
        <div name="berita" class="bg-white w-full h-[40px] flex hover:bg-[#f3f1f1] hover:bg-opacity-30">
          <div class="bg-transparent w-[45px] flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000000" viewBox="0 0 256 256"><path d="M216,40H40A16,16,0,0,0,24,56V216a8,8,0,0,0,11.58,7.15L64,208.94l28.42,14.21a8,8,0,0,0,7.16,0L128,208.94l28.42,14.21a8,8,0,0,0,7.16,0L192,208.94l28.42,14.21A8,8,0,0,0,232,216V56A16,16,0,0,0,216,40Zm0,163.06-20.42-10.22a8,8,0,0,0-7.16,0L160,207.06l-28.42-14.22a8,8,0,0,0-7.16,0L96,207.06,67.58,192.84a8,8,0,0,0-7.16,0L40,203.06V56H216ZM136,112a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,112Zm0,32a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,144ZM64,168h48a8,8,0,0,0,8-8V96a8,8,0,0,0-8-8H64a8,8,0,0,0-8,8v64A8,8,0,0,0,64,168Zm8-64h32v48H72Z"></path></svg>
          </div>
          <div class="bg-transparent w-[174px] flex items-center font-normal text-[17px] hover:font-medium cursor-pointer">Berita</div>
        </div>
        <!-- keluar -->
  ...
  ?>
      ...
      <div class="bg-transparent w-full h-screen">
        ...
        <div class="bg-transparent w-full h-[300px] mt-5 flex">
          <div class="bg-white w-[320px] h-full ml-8 shadow-lg rounded-xl">
            <div class="bg-transparent w-full h-[30px] flex">
                <div class="bg-transparent w-[30px] h-full ml-64 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#59a1ee" viewBox="0 0 256 256"><path d="M227.31,73.37,182.63,28.68a16,16,0,0,0-22.63,0L36.69,152A15.86,15.86,0,0,0,32,163.31V208a16,16,0,0,0,16,16H92.69A15.86,15.86,0,0,0,104,219.31L227.31,96a16,16,0,0,0,0-22.63ZM192,108.68,147.31,64l24-24L216,84.68Z"></path></svg></div>
                <div class="bg-transparent w-[30px] h-full flex items-center justify-center "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#ea3939" viewBox="0 0 256 256"><path d="M224,56a8,8,0,0,1-8,8h-8V208a16,16,0,0,1-16,16H64a16,16,0,0,1-16-16V64H40a8,8,0,0,1,0-16H216A8,8,0,0,1,224,56ZM88,32h80a8,8,0,0,0,0-16H88a8,8,0,0,0,0,16Z"></path></svg></div>
            </div>
            <div class="bg-white w-full h-[40px] mt-3 font-semibold text-[#3B86FE] flex items-center justify-center text-[25px]">PENGINGAT</div>
            <div class="bg-white w-full h-[140px] mt-3 font-semibold flex items-center justify-center text-center text-[20px]">Jangan sibuk saja, jadilah efektif. Fokus pada apa yang benar-benar penting</div>
            <div class="bg-white w-full h-[40px] mt-3 flex items-center justify-center">
            <button class="bg-[#3B86FE] w-[290px] h-[40px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1]">Tambah Pengingat</button>
            </div>
          </div>
          <div class="bg-white w-[720px] h-full shadow-lg rounded-xl ml-8">
            ...
            <div class="bg-transparent w-full h-[35px] pl-3 flex">
                ...
                <select name="" id="" class="w-[90px] h-[35px] text-black pl-[15px] pb-[2px] border-2 border-black rounded-lg shadow-md ml-2">
                    <option value="">2024</option>
                    <option value=""></option>
                    <option value=""></option>
                </select>
                <button class="bg-[#3B86FE] w-[65px] h-[35px] rounded-lg flex items-center justify-center font-semibold text-white text-[15px] hover:bg-[#336fd1] ml-3">Cari</button>
            </div>
          </div>
        </div>
      </div>
